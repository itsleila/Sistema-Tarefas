import{r as i,u as g,p,j as e,D as C,a as h,b as y,L as v}from"./index-B7f7ieIX.js";import{I as b,D as S}from"./AvatarIconCoala-CmO7P5Lw.js";import{c as A,a as D,D as t}from"./firebase-B00g8A_j.js";import{D as f}from"./index-C_GkTooO.js";function w(){const[o,u]=i.useState(""),[n,d]=i.useState(""),[c,x]=i.useState(""),[l,s]=i.useState(""),[m,r]=i.useState(""),j=g();return{email:o,setEmail:u,senha:n,setSenha:d,confirmarSenha:c,setConfirmarSenha:x,error:l,successMessage:m,handleCreateAccount:async()=>{if(n!==c){s("As senhas não correspondem.");return}else s("");try{const a=await A(D,o,n),L={id:a.user.uid,email:a.user.email};r("Usuário criado com sucesso!"),setTimeout(()=>{j("/")},2e3)}catch(a){a.code==="auth/email-already-in-use"?s("O email já está em uso."):a.code==="auth/weak-password"?s("A senha é muito fraca."):s(a.message)}}}}const E=p.div`
  display: flex;
